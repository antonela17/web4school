            ...
            <form action="{{ route('profile.update') }}" method="POST" class="w-full max-w-2xl mx-auto px-6 py-12 flex flex-wrap justify-between" enctype="multipart/form-data">
                ...
                <div class="w-full sm:w-auto order-last sm:order-first">
                    ...
                    <div class="w-full sm:w-auto order-last sm:order-first">
                        <div class="md:flex md:items-center mb-4">
                            <div class="md:w-1/3">
                                <label for="surname" class="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4">
                                    Surname:
                                </label>
                            </div>
                            <div class="md:w-2/3">
                    ...
                    <div class="md:flex md:items-center mb-4">
                        <div class="md:w-1/3">
                            <label for="profile_picture" class="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4">
                                Picture :
                            </label>
                        </div>
                        <div class="md:w-2/3">
                ...
                <div class="order-first sm:order-last mb-4">
                    <div>
                        <img class="w-32 h-32 rounded" src="{{ asset('img/profile/' . auth()->user()->profile_picture) }}" alt="avatar">
                    </div>
                </div>
            </form>
        </div>
