<div class="bg-blue-700 px-4 sm:px-6 py-3 flex items-center justify-between shadow h-16 fixed top-0 left-0 right-0 z-50">
    <div class="flex items-center text-white">
        ...
        <span class="font-semibold text-sm sm:text-xl tracking-tight">Web 4 School</span>
    </div>
    <div class="flex items-right cursor-pointer" >
        <p class="text-sm text-white font-semibold leading-none"><a href="/contact">Contact us</a> </p>
    </div>
    <div class="relative">
        @auth
