        ...
        <div class="mt-8 bg-white rounded">
            <div class="w-full max-w-2xl px-6 py-12">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <span class="block text-gray-600 font-bold">{{ $student->name }}</span>
                    </div>
                </div>
                <div class="md:flex md:items-center mb-6">
                    <div class="md:w-1/3">
                    ...
                    <div class="md:w-2/3">
                        <span class="block text-gray-600 font-bold">{{ $student->surname }}</span>
                    </div>
                </div>
                <div class="md:flex md:items-center mb-6">
                    <div class="md:w-1/3">
                    ...
                    <div class="md:w-2/3">
                        <span class="text-gray-600 font-bold">{{ $student->email }}</span>
                    </div>
                </div>
