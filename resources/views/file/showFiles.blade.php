                    ...
                    @foreach($files as $file)
                        <li style="padding-bottom: 10px ">
                            <div >
                                ...
                                <a href="/file?filename={{$file}}" style=" display:inline-flex;color: #2c5282">
                                    <img
                                   ...
                                   style="height: 35px;width: 30px">
                                    <span class="ml-2 text-xs font-semibold " style="font-size: 20px;font-family: Arial, Helvetica, sans-serif">  {{$file}}</span>
                                </a>
                            </div>
                        </li>
